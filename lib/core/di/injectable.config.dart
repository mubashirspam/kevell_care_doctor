...
import '../../features/checkup/data/repository/subscribe_impliment.dart'
    as _i31;
import '../../features/checkup/data/repository/unloack_impliment.dart' as _i33;
...
import '../../features/checkup/domain/repository/unlock_mqtt_repository.dart'
    as _i32;
import '../../features/checkup/presentation/bloc/checkup_bloc.dart' as _i38;
...
import '../../features/login/data/repositories/login_repository_impl.dart'
    as _i26;
import '../../features/login/domain/repositories/login_repository.dart' as _i25;
...
import '../../features/schedule/domain/repositories/get_schedule_repository.dart'
    as _i19;
import '../../features/schedule/presentation/bloc/schedule_bloc.dart' as _i27;
...
import '../../features/signup/domain/repositories/signup_repository.dart'
    as _i28;
import '../../features/signup/presentation/bloc/signup_bloc.dart' as _i42;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i9.GetHomeStatusRepository>(
        () => _i10.GetProfileRepoImpliment());
    gh.lazySingleton<_i11.GetPatientHistoryListRepository>(
        () => _i12.GetPatientHistoryListRepoImpliment());
    gh.lazySingleton<_i13.GetPrescriptionListRepository>(
        () => _i14.GetPrescriptionListRepoImpliment());
    gh.lazySingleton<_i15.GetPrescriptionSettingsRepository>(
        () => _i16.GetPrescriptionSettingsRepoImpliment());
    gh.lazySingleton<_i17.GetProfileRepository>(
        () => _i18.GetProfileRepoImpliment());
    gh.lazySingleton<_i19.GetScheduleRepository>(
        () => _i20.GetScheduleRepoImpliment());
    gh.lazySingleton<_i21.GetWaitingPatientRepository>(
        () => _i22.UpdateProfileRepoImpliment());
    gh.factory<_i23.HistoryBloc>(
        () => _i23.HistoryBloc(gh<_i11.GetPatientHistoryListRepository>()));
    gh.factory<_i24.HomeBloc>(() => _i24.HomeBloc(
          gh<_i9.GetHomeStatusRepository>(),
          gh<_i21.GetWaitingPatientRepository>(),
        ));
    gh.lazySingleton<_i25.LoginRepository>(() => _i26.LoginRepoImpliment());
    gh.factory<_i27.ScheduleBloc>(() => _i27.ScheduleBloc(
          gh<_i19.GetScheduleRepository>(),
          gh<_i5.CreateScheduleRepository>(),
          gh<_i7.DeleteScheduleRepository>(),
        ));
    gh.lazySingleton<_i28.SignupRepository>(() => _i29.SignupRepoImpliment());
    gh.lazySingleton<_i30.SubscribeRepository>(
        () => _i31.SubscribetRepoImpliment());
    gh.lazySingleton<_i32.UnloackRepository>(() => _i33.UnloackRepoImpliment());
    gh.lazySingleton<_i34.UpdatePrescriptionListRepository>(
        () => _i35.UpdatePrescriptionListRepoImpliment());
    gh.lazySingleton<_i36.UpdateProfileRepository>(
        () => _i37.UpdateProfileRepoImpliment());
    gh.factory<_i38.CheckupBloc>(() => _i38.CheckupBloc(
          gh<_i30.SubscribeRepository>(),
          gh<_i32.UnloackRepository>(),
        ));
    gh.factory<_i39.LoginBloc>(
        () => _i39.LoginBloc(gh<_i25.LoginRepository>()));
    gh.factory<_i40.PrecriptionBloc>(() => _i40.PrecriptionBloc(
          gh<_i13.GetPrescriptionListRepository>(),
          gh<_i15.GetPrescriptionSettingsRepository>(),
          gh<_i3.CreatePrescriptionListRepository>(),
          gh<_i34.UpdatePrescriptionListRepository>(),
        ));
    ...
    gh.factory<_i42.SignupBloc>(
        () => _i42.SignupBloc(gh<_i28.SignupRepository>()));
    return this;
  }
}
