...
import '../../features/checkup/domain/repository/unlock_mqtt_repository.dart'
    as _i40;
import '../../features/checkup/presentation/bloc/checkup_bloc.dart' as _i50;
...
import '../../features/login/presentation/bloc/login_bloc.dart' as _i51;
...
import '../../features/profile/domain/repositories/upload_image_repository.dart'
    as _i48;
import '../../features/profile/presentation/bloc/profile_bloc.dart' as _i53;
...
import '../../features/schedule/domain/repositories/update_schedule_repository.dart'
    as _i46;
import '../../features/schedule/presentation/bloc/schedule_bloc.dart' as _i54;
...
import '../../features/signup/domain/repositories/signup_repository.dart'
    as _i36;
import '../../features/signup/presentation/bloc/signup_bloc.dart' as _i55;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i50.CheckupBloc>(() => _i50.CheckupBloc(
          gh<_i38.SubscribeRepository>(),
          gh<_i40.UnloackRepository>(),
          gh<_i11.EndAppoinmentRepository>(),
        ));
    gh.factory<_i51.LoginBloc>(
        () => _i51.LoginBloc(gh<_i33.LoginRepository>()));
    gh.factory<_i52.PrecriptionBloc>(() => _i52.PrecriptionBloc(
    ...
    gh.factory<_i54.ScheduleBloc>(() => _i54.ScheduleBloc(
    ...
    gh.factory<_i55.SignupBloc>(
        () => _i55.SignupBloc(gh<_i36.SignupRepository>()));
    return this;
  }
}
