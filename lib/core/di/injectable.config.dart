...
import '../../features/forgot_password_screen/data/repositories/forgot_password_repository_impl.dart'
    as _i18;
import '../../features/forgot_password_screen/domain/repositories/forgot_password_repository.dart'
    as _i17;
import '../../features/forgot_password_screen/presentation/bloc/forgot_password_bloc.dart'
    as _i54;
...
import '../../features/login/presentation/bloc/login_bloc.dart' as _i55;
...
import '../../features/profile/domain/repositories/upload_image_repository.dart'
    as _i50;
import '../../features/profile/presentation/bloc/profile_bloc.dart' as _i57;
...
import '../../features/schedule/domain/repositories/update_schedule_repository.dart'
    as _i48;
import '../../features/schedule/presentation/bloc/schedule_bloc.dart' as _i58;
...
import '../../features/signup/domain/repositories/signup_repository.dart'
    as _i38;
import '../../features/signup/presentation/bloc/signup_bloc.dart' as _i59;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i17.ForgotPasswordRepository>(
        () => _i18.ForgotPasswordRepoImpliment());
    ...
    gh.factory<_i52.ChatBloc>(
        () => _i52.ChatBloc(gh<_i11.FetchChatProfileRepository>()));
    ...
    gh.factory<_i54.ForgotPasswordBloc>(
        () => _i54.ForgotPasswordBloc(gh<_i17.ForgotPasswordRepository>()));
    gh.factory<_i55.LoginBloc>(
        () => _i55.LoginBloc(gh<_i35.LoginRepository>()));
    gh.factory<_i56.PrecriptionBloc>(() => _i56.PrecriptionBloc(
    ...
    gh.factory<_i58.ScheduleBloc>(() => _i58.ScheduleBloc(
    ...
    gh.factory<_i59.SignupBloc>(
        () => _i59.SignupBloc(gh<_i38.SignupRepository>()));
    return this;
  }
}
