      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            padding: const EdgeInsets.all(6),
            decoration: BoxDecoration(
              color: audioStream != null ? Colors.black87 : Colors.red,
              border: Border.all(
                  color: audioStream != null ? Colors.black45 : Colors.red),
              borderRadius: BorderRadius.circular(30),
            ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: videoStream != null ? Colors.black87 : Colors.red,
              border: Border.all(
                  color: videoStream != null ? Colors.black45 : Colors.red),
              borderRadius: BorderRadius.circular(30),
            ),
