    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          TouchRippleEffect(
            borderRadius: BorderRadius.circular(12),
            rippleColor: isMicEnabled ? context.theme.primary : Colors.white,
            onTap: onMicButtonPressed,
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(12),
                border: Border.all(color: context.theme.secondary!),
                color: isMicEnabled ? context.theme.primary : Colors.white,
              ),
              padding: const EdgeInsets.all(8),
              child: Row(
                children: [
                  Icon(
                    ...
                    size: 30,
                    color: isMicEnabled ? Colors.white : context.theme.primary,
                  ),
                  GestureDetector(
                      onTapDown: (details) =>
          ...
          TouchRippleEffect(
            borderRadius: BorderRadius.circular(12),
            rippleColor: context.theme.primary,
            onTap: onCameraButtonPressed,
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(12),
                border: Border.all(color: context.theme.secondary!),
                color: isCamEnabled ? context.theme.primary : Colors.white,
              ),
              ...
              child: SvgPicture.asset(
                ...
                width: 26,
                height: 26,
                color: isCamEnabled ? Colors.white : context.theme.primary,
              ),
            ),
          ),
